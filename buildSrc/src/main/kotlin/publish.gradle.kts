        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/abdelraoufsabri/jcsample1/")
                    ...
                    developers {
                        developer {
                            id.set("abdelraoufsabri")
                            name.set("abdelraoufsabri")
                        }
                    }
                    scm {
                        connection.set("scm:git:git://github.com/abdelraoufsabri/jcsample1.git")
                        developerConnection.set("scm:git:ssh://github.com/abdelraoufsabri/jcsample1.git")
                        url.set("https://github.com/abdelraoufsabri/jcsample1/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/abdelraoufsabri/jcsample1/issues")
                    }
                }
            }
        }
