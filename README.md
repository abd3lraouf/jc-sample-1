...
![Build](https://github.com/AbdElraoufSabri/jc-sample-1/workflows/Pre%20Merge%20Checks/badge.svg)
...
- [ ] Choose a [LICENSE](https://github.com/AbdElraoufSabri/jc-sample-1/community/license/new?branch=master).
- [ ] Set your `ORG_GRADLE_PROJECT_NEXUS_USERNAME`, `ORG_GRADLE_PROJECT_NEXUS_PASSWORD`, `ORG_GRADLE_PROJECT_SIGNING_KEY` and `ORG_GRADLE_PROJECT_SIGNING_PWD` secrets in [Settings](https://github.com/AbdElraoufSabri/jc-sample-1/settings/secrets/actions).
